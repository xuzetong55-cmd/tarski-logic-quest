...
function App() {
  const [workspaceMode, setWorkspaceMode] = useState<WorkspaceMode>('tarski')
    ...
    <main className="app-shell">
      <aside className="sidebar" aria-label="课程关卡">
        ...
        <div className="mode-switch" role="group" aria-label="学习模式">
          <button
            className={workspaceMode === 'tarski' ? 'active' : ''}
            type="button"
            onClick={() => setWorkspaceMode('tarski')}
          >
            Tarski 关卡
          </button>
          <button
